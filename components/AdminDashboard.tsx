            ...
            <>
              {(() => {
                ...
                const handleSendWhatsAppDashboardSpot = () => {
                   ...
                   const target = spotRecipient === 'custom' ? customSpotRecipient : spotRecipient;
                   handleSendWhatsapp(msg, target);
                };
                    ...
                    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden shadow-sm w-full">
                       <div className="px-6 py-4 bg-slate-50 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                         ...
                         <div className="flex flex-wrap items-center gap-3">
                            ...
                            <select
                              value={spotRecipient}
                              onChange={(e) => setSpotRecipient(e.target.value)}
                            ...
                            {spotRecipient === 'custom' && (
                              <input
                                type="text"
                                placeholder="Número ou ID de grupo..."
                                value={customSpotRecipient}
                                onChange={(e) => setCustomSpotRecipient(e.target.value)}
             ...
             return (
               <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-800/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] p-6 mt-8">
                 <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 border-b border-slate-100 dark:border-slate-800 pb-4">
                  ...
                  {(() => {
                    const excludedSvcIds = ['SSP49', 'SSP57', 'SSP18', 'FIRST MILE', 'JUNDIAÍ', 'OSASCO', 'SSP20', 'SSP37', 'SSP30', 'SSP34'];
                        ...
                        {visibleSemDriver.length > 0 && (
                          <div className="space-y-2 border border-orange-100 dark:border-orange-900/30 p-3 rounded-xl bg-orange-50/50 dark:bg-orange-900/10">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                              ...
                              <div className="flex flex-wrap items-center gap-3">
                                <select
                                  value={semDriverRecipient}
                                  onChange={(e) => setSemDriverRecipient(e.target.value)}
                                  className="px-3 py-2 text-xs font-bold rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 focus:ring-primary/20 shadow-sm"
                                >
                                  <option value="">Grupo Geral (Padrão)</option>
                                  <option value="5515996813326">Grupo de Erros (5515996813326)</option>
                                ...
                                {semDriverRecipient === 'custom' && (
                                  <input
                                    type="text"
                                    placeholder="Número ou ID de grupo..."
                                    value={customSemDriverRecipient}
                                    onChange={(e) => setCustomSemDriverRecipient(e.target.value)}
                                    className="px-3 py-2 text-xs font-medium rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 focus:ring-primary/20 shadow-sm w-44"
                                  />
                                )}
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    const target = semDriverRecipient === 'custom' ? customSemDriverRecipient : semDriverRecipient;
                                    handleSendWhatsapp(mensagem, target);
                                  }}
                                  className={`px-4 py-2 text-white text-xs font-bold rounded-xl flex items-center gap-2 active:scale-95 transition-all shadow-md ${sendingWhatsapp ? 'bg-slate-400 cursor-not-allowed shadow-none' : 'bg-[#25D366] hover:bg-[#1DA851] shadow-green-500/20'}`}
                                >
